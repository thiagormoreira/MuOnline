...
//======================================================
	...
	#define GAMESERVER_REMOVE_MDRIVE				DEFINE_DISABLED
...
#endif
#if GAMESERVER_VERSION == 0 && GAMESERVER_TYPE == 1		// GameServer 1.00.90, Type Siege
...
// GameServer 1.00.18, Type Normal
//======================================================
#else if GAMESERVER_VERSION == 1 && GAMESERVER_TYPE == 0
